$(function() {
    ...
    //アルファベット画像
    let alphabetDImg = new Image();
    alphabetDImg.src = "./img/d.png";
    ...
    lines.push({'start': [gridLeft + cellSize * 1, gridTop + cellSize * 5], 'end': [gridLeft + cellSize * 5, gridTop + cellSize * 5]});
    lines.push({'start': [gridLeft + cellSize * 11, gridTop + cellSize], 'end': [gridLeft + cellSize * 11, gridTop + cellSize * 5]});
    ...
    let drawShapes = function() {
        ...
        //E,Fを描画
        let D1Position = [gridLeft + cellSize * 0.25, gridTop + cellSize * 5.25];
        ctx.drawImage(alphabetDImg, D1Position[0], D1Position[1], cellSize * 0.5, cellSize * 0.5);
        let E1Position = [gridLeft + cellSize * 5.25, gridTop + cellSize * 5.25];
        ctx.drawImage(alphabetEImg, E1Position[0], E1Position[1], cellSize * 0.5, cellSize * 0.5);

        let D2Position = [gridLeft + cellSize * 11.25, gridTop + cellSize * 0.25];
        ctx.drawImage(alphabetDImg, D2Position[0], D2Position[1], cellSize * 0.5, cellSize * 0.5);
        let E2Position = [gridLeft + cellSize * 11.25, gridTop + cellSize * 5.25];
        ctx.drawImage(alphabetEImg, E2Position[0], E2Position[1], cellSize * 0.5, cellSize * 0.5);
